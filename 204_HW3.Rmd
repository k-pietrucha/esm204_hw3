...
# Katie note - tried these but they must be wrong,

tax_cs_sq_high <- 0.5*q_star*((high_y_int/100) - (p_star/100))
# High consumer benefit $55,745.97
tax_cs_sq_low <-0.5*q_star*((tax_low_y_int/100) - ((p_star/100) + MEC)) - (MEC*q_star)
